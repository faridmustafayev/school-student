...
public interface ExceptionConstant {
    String ACTIVITY_NOT_FOUND_CODE = "ACTIVITY_NOT_FOUND";
    String ACTIVITY_NOT_FOUND_MESSAGE = "Activity not found";

    String STUDENT_NOT_FOUND_CODE = "STUDENT_NOT_FOUND";
    String STUDENT_NOT_FOUND_MESSAGE = "Student not found";

    String UNEXPECTED_EXCEPTION_CODE = "UNEXPECTED_EXCEPTION";
    String UNEXPECTED_EXCEPTION_MESSAGE = "Unexpected exception occurred!";

    String SCHOOL_NOT_FOUND_CODE = "SCHOOL_NOT_FOUND";
    String SCHOOL_NOT_FOUND_MESSAGE = "School not found";
